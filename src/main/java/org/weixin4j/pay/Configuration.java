 ...
 *
 * <p>
 * 如果存在weixin4j-pay.properties,则加载属性文件中配置的参数</p>
 *
 * @author yangqisheng
 * @since 1.0.0
 */
public class Configuration {
    ...
    static void init() {
        ...
        //读取自定义配置
        String t4jProps = "weixin4j-pay.properties";
    ...
    public static String getMchId() {
        return getProperty("weixin4j.pay.mchId");
    }
    ...
    public static String getMchKey() {
        return getProperty("weixin4j.pay.mchKey");
    }
